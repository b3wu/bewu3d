    ...
    <div className="min-h-screen bg-[#0B0F14] text-white flex items-center justify-center px-4">
      <div className="w-full max-w-lg rounded-3xl border border-white/10 bg-white/5 p-8 text-center">
        ...
        <p className="mt-2 text-sm text-white/70">
          Twoja prośba o wycenę została wysłana. Odezwiemy się możliwie szybko.
        </p>
        <button onClick={goHome} className="mt-6 rounded-xl bg-gradient-to-r from-[#36F3D6] to-[#00A3FF] px-5 py-2 text-sm font-semibold text-[#0B0F14]">
